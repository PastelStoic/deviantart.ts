  ...
  k.fn.extend({
    ...
    k.each(k.expr.match.bool.source.match(/\w+/g), function (e, t) {
      ...
      gt[t] = function (e, t, n) {
        ...
        return n ||
          (i = gt[o], gt[o] = r, r = null != a(e, t, n) ? o : null, gt[o] = i),
          r;
      };
    });
  ...
  k.ajaxSetup({
    ...
    k.ajaxPrefilter("json jsonp", function (e, t, n) {
      var r,
        ...
        o,
        a = !1 !== e.jsonp &&
          (Yt.test(e.url) ? "url" : "string" == typeof e.data &&
            0 ===
      ...
      if (a || "jsonp" === e.dataTypes[0]) {
        return r = e.jsonpCallback = m(e.jsonpCallback)
          ? e.jsonpCallback()
          : e.jsonpCallback,
          a ? e[a] = e[a].replace(Yt, "$1" + r) : !1 !== e.jsonp &&
  ...
  function () {
    ...
    h.extend = R(h.allKeys),
      ...
      h.findKey = function (n, r, t) {
        r = d(r, t);
        for (
          var e, u = h.keys(n), i = 0, o = u.length;
          i < o;
          i++
        ...
        if (!i) {
          ...
          if (
            ...
            !(h.isFunction(o) && o instanceof o && h.isFunction(a) &&
              a instanceof a) &&
            "constructor" in n && "constructor" in r
          ) return !1;
        }
        e = e || [];
  ...
  function (t) {
      ...
      set: function (t, e) {
        if (null != t) {
          ...
          for (m = 0; m < t.length; m++) {
            ...
            } else {l && (g = t[m] = this._prepareModel(g, e)) &&
                (a.push(g),
    ...
    B.started = !1,
      i.extend(B.prototype, a, {
        ...
        getFragment: function (t) {
          return null == t &&
            (t = this._usePushState || !this._wantsHashChange
              ? this.getPath()
              : this.getHash()),
            t.replace(J, "");
        },
    ...
    m.extend =
      ...
      B.extend =
        function (t, e) {
          var r, n = this;
          return r = t && i.has(t, "constructor")
            ? t.constructor
            : function () {
              return n.apply(this, arguments);
            },
      ...
      e.Index.prototype.query = function (t) {
        ...
        for (u = 0; u < C.length; u++) {
          ...
          if (R.contains(D) && !F.contains(D)) {
            ...
            if (void 0 !== (A = _[D])) {A.score += V,
                A.matchData.combine(i[j]);} else {
        ...
        for (var s = 0; s < n.length; s++) {
          ...
          for (var f = 0; f < c.length; f++) {
            ...
            if (
              ...
              for (var m = 0; m < n.length; m++) {y[n[m]] = Object.create(
                  null,
                );}
...
!function (typedoc) {
  ...
  function (typedoc) {
    ...
    var MenuSticky = function (_super) {
      ...
      return __extends(MenuSticky, _super),
            ...
            if (this.$current.length) {
              ...
              this.$navigation.css("top", containerTop - currentTop + 20),
                ...
                (this.stickyMode = StickyMode.Current,
                  ...
                  this.stickyBottom = bottom - elHeight + (currentTop - elTop) -
                    20);
            }
            elHeight < height &&
